...
for k = 3:length(D_data) % avoid using the first ones
    ...
    try
        [electsig,electnonsig,electall, electsig75,electnonsig75,electall75,electsig25,electnonsig25,electall25,p,stimshank,othershank,meansig50, meansig75,meansig25, stdersig50, stdersig75,stdersig25,Stimchn]=RATIOLOOP_MASSIVE([D_data(k).folder filesep currD])
