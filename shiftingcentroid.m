...
for AmpI=2:length(AMP)
    ...
    if AmpI==2
        ...
        accrossshank_all.T25=accrossshank(17:32,:); %5cond*16elect,4shanks*AMP
        accrossshank_all.T50=accrossshank(33:48,:); %5cond*16elect,4shanks*AMP
        accrossshank_all.T75=accrossshank(49:64,:); %5cond*16elect,4shanks*AMP
        accrossshank_all.T100=accrossshank(65:80,:); %5cond*16elect,4shanks*AMP
    else
        accrossshank_all.T0=[accrossshank_all.T0;accrossshank(1:16,:)]; %5cond*16elect,4shanks*AMP
        accrossshank_all.T25=[accrossshank_all.T25;accrossshank(17:32,:)]; %5cond*16elect,4shanks*AMP
        accrossshank_all.T50=[accrossshank_all.T50;accrossshank(33:48,:)]; %5cond*16elect,4shanks*AMP
        accrossshank_all.T75=[accrossshank_all.T75;accrossshank(49:64,:)]; %5cond*16elect,4shanks*AMP
        accrossshank_all.T100=[accrossshank_all.T100;accrossshank(65:80,:)]; %5cond*16elect,4shanks*AMP
    end
end
%stimshankcentroid_all_r945=stimshankcentroid_all;
ac_r9e9=accrossshank_all;
close all
%%
clear resultind
AMP=loadAMP;
...
%% result calc with currents
 ...
 totalac0=[ac_r9e7.T0;ac_r9e9.T0;ac_r9e11.T0;ac_r8e5.T0;ac_r8e6.T0;ac_r6e10.T0;ac_r6e9.T0];
  totalac50=[ac_r9e7.T50;ac_r9e9.T50;ac_r9e11.T50;ac_r8e5.T50;ac_r8e6.T50;ac_r6e10.T50;ac_r6e9.T50];
  totalac100=[ac_r9e7.T100;ac_r9e9.T100;ac_r9e11.T100;ac_r8e5.T100;ac_r8e6.T100;ac_r6e10.T100;ac_r6e9.T100];
  totalac75=[ac_r9e7.T75;ac_r9e9.T75;ac_r9e11.T75;ac_r8e5.T75;ac_r8e6.T75;ac_r6e10.T0;ac_r6e9.T75];
  totalac25=[ac_r9e7.T25;ac_r9e9.T25;ac_r9e11.T25;ac_r8e5.T25;ac_r8e6.T25;ac_r6e10.T25;ac_r6e9.T25];
          resultind=zeros(4,1);
