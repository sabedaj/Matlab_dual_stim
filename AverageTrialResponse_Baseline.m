function [avgnospT,stderrspktrial,trialinfo] = AverageTrialResponse_Baseline(IDstruct, baslinespikestruct)
...
for ID=1:maxtid
    check=['T' num2str(ID)];
    IDstructnobsp.(check)=baslinespikestruct.(check);%IDstruct.(check)-baslinespikestruct.(check);
