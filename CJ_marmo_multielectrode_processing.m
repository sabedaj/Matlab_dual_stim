...
parfor k = 3:length(D_data) % loop through the stimulation pairs. Avoid using the first ones
    ...
    savefilename{k}=[{str2double(stimfilename.name(end-6:end-4))} {stimVar} {stimfilename.folder(end-12:end-7)} {[TrialsSingleElect ampsingle chnsingle]} {stimfilename.folder(end-12:end)}];
